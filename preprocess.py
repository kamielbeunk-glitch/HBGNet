...
def distance_boundary(maskRoot, distRoot, boundaryRoot):
...
if __name__ == "__main__":
    # Train
    maskRoot = r"./inputs/train/train_mask"
    distRoot = r"./inputs/train/train_dist"
    boundaryRoot = r"./inputs/train/train_boundary"
    distance_boundary(maskRoot, distRoot, boundaryRoot)

    # Test
    # maskRoot = r"./inputs/test/train_mask"
    # distRoot = r"./inputs/test/train_dist"
    # boundaryRoot = r"./inputs/test/train_boundary"
    # distance_boundary(maskRoot, distRoot, boundaryRoot)
